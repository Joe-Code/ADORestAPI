...
# Create new project named JTFRESTDemo
$projectName = "JTFRESTDemo"
$createProjectURL = "$orgUrl/_apis/projects?$queryString"
$projectJSON = @{name = "$($projectName)"
               description = "JTF Azure DevOps REST API Demo"
               capabilities = @{
                  versioncontrol = @{
...
# Update Project description of JTFRESTDemo project
$jsonData = @{description = "This is the updated project description for JTFRESTDemo"
         } | ConvertTo-Json
